...
<c:forEach items="${item1Arr }" var="itemOP1">
	...
	<c:if test="${itemOP1>=1 }">
						...
						<div class="item_ops1">
	<c:forEach begin="1" end="${itemOP1 }">
						<input type="text" class="item1" placeholder="작성 예시: 가로x세로x높이 ">
	</c:forEach>
						</div>	
	</c:if>					 
</c:forEach>
...
<c:forEach items="${item2Arr }" var="itemOP2">
	...
	<c:if test="${itemOP2>=1 }">
						...
						<div class="item_ops2">
	<c:forEach begin="1" end="${itemOP2 }">
						<input type="text" class="item2" placeholder="작성 예시: 가로x세로x높이 ">
	</c:forEach>
						</div>	
	</c:if>						 
</c:forEach>
...
<c:forEach items="${item3Arr }" var="itemOP3">
	...
	<c:if test="${itemOP3>=1 }">
						...
						<div class="item_ops3">
	<c:forEach begin="1" end="${itemOP3 }">
						<input type="text" class="item3" placeholder="작성 예시: 가로x세로x높이 ">
	</c:forEach>
						</div>	
	</c:if>					 
</c:forEach>
