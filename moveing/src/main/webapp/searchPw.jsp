...
public class MyAuthentication extends Authenticator { //아이디 패스워드 인증받기 함수
  ...
  public MyAuthentication(){
    pa=new PasswordAuthentication("qlqlel0909@gmail.com","000");        
  }
  @Override
...
<%
 ...
 //보내는 사람의 정보
 String fromName = "나홀로이사";
 String fromEmail = "qlqlel0909@gmail.com";
...
props.put("mail.smtp.socketFactory.fallback", "false");
  ...
  msg.setFrom(addr);         
  msg.setSubject(MimeUtility.encodeText("나홀로이사 비밀번호 변경", "utf-8","B"));
